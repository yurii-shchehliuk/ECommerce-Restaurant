...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["polyfills-es5"], {
    ...
    */
    ...
    (function (factory) {
      ...
      Zone.__load_patch('ZoneAwarePromise', function (global, Zone, api) {
        ...
        BaseAPI.onUnhandledError = function (e) {
        ...
        BaseAPI.microtaskDrainDone = function () {
            ...
            if (state !== REJECTED && value instanceof ZoneAwarePromise && value.hasOwnProperty(symbolState) && value.hasOwnProperty(symbolValue) && value[symbolState] !== UNRESOLVED) {
              ...
              if (queue.length == 0 && state == REJECTED) {
                ...
                try {
                  ...
                  BaseAPI.scheduleMicroTask(); // to make sure that it is running
                }
              }
            }
        ...
        if (!desc || desc.configurable) {
          ...
          desc.set = function (NewNativePromise) {
            if (NewNativePromise === ZoneAwarePromise) {
              ...
              BaseAPI.setNativePromise(NewNativePromise);
            }
          };
      ...
      function patchEventPrototype(global, api) {
        ...
        if (Event && Event.prototype) {
          BaseAPI.patchMethod(Event.prototype, 'stopImmediatePropagation', function (delegate) {
            return function (self, args) {
      ...
      function patchCallbacks(api, target, targetName, method, callbacks) {
          ...
          if (opts && opts.prototype) {
            callbacks.forEach(function (callback) {
              ...
              if (prototype.hasOwnProperty(callback)) {
                var descriptor = BaseAPI.ObjectGetOwnPropertyDescriptor(prototype, callback);

                if (descriptor && descriptor.value) {
                  descriptor.value = BaseAPI.wrapWithCurrentZone(descriptor.value, source);

                  BaseAPI._redefineProperty(opts.prototype, callback, descriptor);
                } else if (prototype[callback]) {
                  prototype[callback] = BaseAPI.wrapWithCurrentZone(prototype[callback], source);
                }
              } else if (prototype[callback]) {
                prototype[callback] = BaseAPI.wrapWithCurrentZone(prototype[callback], source);
              }
        ...
        BaseAPI.attachOriginToPatched(target[method], nativeDelegate);
      }
      /**
       * @license
       * Copyright Google Inc. All Rights Reserved.
      ...
      Zone.__load_patch('util', function (global, Zone, api) {
        BaseAPI.patchOnProperties = patchOnProperties;
        BaseAPI.patchMethod = patchMethod;
        BaseAPI.bindArguments = bindArguments;
        BaseAPI.patchMacroTask = patchMacroTask; // In earlier version of zone.js (<0.9.0), we use env name `__zone_symbol__BLACK_LISTED_EVENTS` to
        ...
        BaseAPI.patchEventPrototype = patchEventPrototype;
        BaseAPI.patchEventTarget = patchEventTarget;
        BaseAPI.isIEOrEdge = isIEOrEdge;
        BaseAPI.ObjectDefineProperty = ObjectDefineProperty;
        BaseAPI.ObjectGetOwnPropertyDescriptor = ObjectGetOwnPropertyDescriptor;
        BaseAPI.ObjectCreate = ObjectCreate;
        BaseAPI.ArraySlice = ArraySlice;
        BaseAPI.patchClass = patchClass;
        BaseAPI.wrapWithCurrentZone = wrapWithCurrentZone;
        BaseAPI.filterProperties = filterProperties;
        BaseAPI.attachOriginToPatched = attachOriginToPatched;
        BaseAPI._redefineProperty = Object.defineProperty;
        BaseAPI.patchCallbacks = patchCallbacks;

        BaseAPI.getGlobalObjects = function () {
          return {
      ...
      function patchCustomElements(_global, api) {
        var _api$getGlobalObjects = BaseAPI.getGlobalObjects(),
        ...
        BaseAPI.patchCallbacks(api, _global.customElements, 'customElements', 'define', callbacks);
      }
      /**
       * @license
       * Copyright Google Inc. All Rights Reserved.
      ...
      function eventTargetPatch(_global, api) {
        ...
        var _api$getGlobalObjects2 = BaseAPI.getGlobalObjects(),
        ...
        BaseAPI.patchEventTarget(_global, [EVENT_TARGET && EVENT_TARGET.prototype]);
        return true;
      }

      function patchEvent(global, api) {
        BaseAPI.patchEventPrototype(global, api);
      }
      /**
       * @license
       * Copyright Google Inc. All Rights Reserved.
      ...
      Zone.__load_patch('EventTarget', function (global, Zone, api) {
        ...
        if (XMLHttpRequestEventTarget && XMLHttpRequestEventTarget.prototype) {
          BaseAPI.patchEventTarget(global, [XMLHttpRequestEventTarget.prototype]);
        }
    ...
    */
    ...
    (function (factory) {
      ...
      function eventTargetLegacyPatch(_global, api) {
        var _a = BaseAPI.getGlobalObjects(),
        ...
        var ieOrEdge = BaseAPI.isIEOrEdge();
        ...
        BaseAPI.patchEventTarget(_global, apiTypes, {
      ...
      function apply(api, _global) {
        ...
        if (!_global.EventTarget) {
          BaseAPI.patchEventTarget(_global, [WS.prototype]);
        }
        ...
        _global.WebSocket = function (x, y) {
          ...
          var onmessageDesc = BaseAPI.ObjectGetOwnPropertyDescriptor(socket, 'onmessage');

          if (onmessageDesc && onmessageDesc.configurable === false) {
            proxySocket = BaseAPI.ObjectCreate(socket); // socket have own property descriptor 'onopen', 'onmessage', 'onclose', 'onerror'
            ...
            [ADD_EVENT_LISTENER_STR, REMOVE_EVENT_LISTENER_STR, 'send', 'close'].forEach(function (propName) {
              proxySocket[propName] = function () {
                var args = BaseAPI.ArraySlice.call(arguments);
          ...
          BaseAPI.patchOnProperties(proxySocket, ['close', 'error', 'message', 'open'], proxySocketProto);
          return proxySocket;
        };
      ...
      function propertyDescriptorLegacyPatch(api, _global) {
        ...
        if (!canPatchViaPropertyDescriptor(api, _global)) {
          ...
          BaseAPI.patchClass('XMLHttpRequest');
      ...
      function canPatchViaPropertyDescriptor(api, _global) {
        ...
        if ((isBrowser || isMix) && !api.ObjectGetOwnPropertyDescriptor(HTMLElement.prototype, 'onclick') && typeof Element !== 'undefined') {
          ...
          var desc = BaseAPI.ObjectGetOwnPropertyDescriptor(Element.prototype, 'onclick');
          ...
          if (desc) {
            BaseAPI.ObjectDefineProperty(Element.prototype, 'onclick', {
              enumerable: true,
              configurable: true,
              get: function get() {
                return true;
            ...
            BaseAPI.ObjectDefineProperty(Element.prototype, 'onclick', desc);
            return result;
          }
        }
        ...
        var XMLHttpRequestPrototype = XMLHttpRequest.prototype;
        var xhrDesc = BaseAPI.ObjectGetOwnPropertyDescriptor(XMLHttpRequestPrototype, ON_READY_STATE_CHANGE); // add enumerable and configurable here because in opera
        ...
        if (xhrDesc) {
          BaseAPI.ObjectDefineProperty(XMLHttpRequestPrototype, ON_READY_STATE_CHANGE, {
            enumerable: true,
            configurable: true,
            get: function get() {
              return true;
          ...
          BaseAPI.ObjectDefineProperty(XMLHttpRequestPrototype, ON_READY_STATE_CHANGE, xhrDesc || {});
          return result;
        } else {
          var SYMBOL_FAKE_ONREADYSTATECHANGE_1 = BaseAPI.symbol('fake');
          BaseAPI.ObjectDefineProperty(XMLHttpRequestPrototype, ON_READY_STATE_CHANGE, {
            enumerable: true,
            configurable: true,
            get: function get() {
      ...
      function patchViaCapturingAllTheEvents(api) {
        var eventNames = BaseAPI.getGlobalObjects().eventNames;
        var unboundKey = BaseAPI.symbol('unbound');
          ...
          self.addEventListener(property, function (event) {
            ...
            while (elt) {
              if (elt[onproperty] && !elt[onproperty][unboundKey]) {
                bound = BaseAPI.wrapWithCurrentZone(elt[onproperty], source);
      ...
      function registerElementPatch(_global, api) {
        ...
        BaseAPI.patchCallbacks(api, document, 'Document', 'registerElement', callbacks);
      }
      /**
       * @license
       * Copyright Google Inc. All Rights Reserved.
      ...
      (function (_global) {
        ...
        _global[__symbol__('legacyPatch')] = function () {
          ...
          Zone.__load_patch('defineProperty', function (global, Zone, api) {
            BaseAPI._redefineProperty = _redefineProperty;
            propertyPatch();
          });
  ...
  function _(module, exports, __webpack_require__) {
    __webpack_require__(
    /*! C:\Users\yshchehliuk\source\pracaDyplomowaX\Food-App_Web_\client\node_modules\@angular-devkit\build-angular\src\angular-cli-files\models\es5-polyfills.js */
    "./node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/es5-polyfills.js");
    ...
    /*! C:\Users\yshchehliuk\source\pracaDyplomowaX\Food-App_Web_\client\src\polyfills.ts */
    "./src/polyfills.ts");
    /***/
  }
}, [[1, "runtime"]]]);
